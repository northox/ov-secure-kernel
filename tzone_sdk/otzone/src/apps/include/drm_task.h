...
/**
 * @brief Interrupt handler for drm task
 *
 ...
 * @param data: TLS data
 */
void drm_task_handler(struct timer_event* tevent);

/**
 * @brief DRM the data for the user supplied buffer with async support
 *
 ...
 */
int process_otz_drm_async_send_cmd(void *req_buf, u32 req_buf_len, 
...
/**
 * @brief DRM the data for IPI testing
 *
 * This function copies the request buffer to response buffer to show the 
 * IPI functionality
 *
 ...
 * SMC_*: An implementation-defined error code for any other error.
 */
int process_otz_drm_ipi_send_cmd(void *req_buf, u32 req_buf_len, 
                             void *res_buf, u32 res_buf_len, 
                             struct otzc_encode_meta *meta_data,
                             u32 *ret_res_buf_len);
